...
--
-- Name: api_clients_have_only_one_active_key; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX api_clients_have_only_one_active_key ON public.api_keys USING btree (client_name) WHERE (deactivated_at IS NULL);
